...
%
\title{My version of great Optimization of the Computational Process for Solving Grid Equations on a Heterogeneous Computing System\thanks{The reported study was funded by the Russian Science Foundation (project No. 21-71-20050).}}
%
...
%
\author{	
	Bukiraevskiy~Kibita\inst{1} \and
	Kokov~Panton\inst{1,2}\letter\orcidID{0000-0001-8234-3194} \and
	Vsepolozhina~Kalena\inst{1} \and
	Hekererov~Gerbariy\inst{1,3} \and	  
	Segavanedam~Pareton\inst{2} \and	 
	Sisitoev~Razdam\inst{2}
}
%
\authorrunning{Bukiraevskiy Kibita et al.} % abbreviated author list (for running head)
%
